              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {savedMealPlans.map((plan) => {
                  ...
                  return (
                    <div
                      key={plan._id}
                      className={`bg-white border rounded-xl p-6 hover:shadow-lg transition-shadow min-h-[400px] flex flex-col ${
                        isExpired
                    ...
                    >
                      ...
                      <div className="flex gap-3">
                        ...
                        >
                          <button className="flex-1 bg-white border border-gray-300 text-gray-700 px-4 py-2.5 rounded-lg font-medium hover:bg-gray-50 transition-colors cursor-pointer">
                            View Plan
                          </button>
                        </Link>
                        <button className="flex-1 bg-white border border-gray-300 text-gray-300 px-4 py-2.5 rounded-lg font-medium cursor-not-allowed">
                          Generate List
                        </button>
                      </div>
...
//           // Response has a plans property containing array
//           allPlans = data.plans;
//         } else if (data && Array.isArray(data.data)) {
//           // Response has a data property containing array
//           allPlans = data.data;
//         } else if (data && data.plans) {
//           // If plans is not array but an object, try to convert
//           allPlans = Object.values(data.plans);
//         }

//         // Now safely filter
//         const savedPlans = Array.isArray(allPlans)
//           ? allPlans.filter((plan) => plan?.isSaved === true)
//           : [];

//         console.log("Saved plans found:", savedPlans.length);
//         setSavedMealPlans(savedPlans);
//       } catch (error) {
//         console.error("Error fetching plans:", error);
//         setSavedMealPlans([]);
...
//       setGroceryListId(groceryListIdFromURL);
//     }
//   }, [isOpen, user?.id, groceryListIdFromURL]);
...
//       //               Save some meal plans to see your favorite recipes here
//       //             </p>
//       //           </div>
//       //         )}
//       //       </div>
...
//               </h3>
//               <p className="text-gray-600 mb-6">
//                 Add items you already have at home to exclude them from grocery lists.
//               </p>
//             </div>
...
//                       <div className="flex gap-3">
//                         <Link
//                           href={`/${locale}/plans/${plan._id}?groceryListId=${plan.groceryListId}`}
//                         >
//                           <button className="flex-1 bg-white border border-gray-300 text-gray-700 px-4 py-2.5 rounded-lg font-medium hover:bg-gray-50 transition-colors cursor-pointer">
//                             View Plan
//                           </button>
