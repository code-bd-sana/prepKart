...
export default function GroceryListPage({ params }) {
  ...
  // Update cart data
  const updateCartData = useCallback((list, instacartLink = null) => {
  ...
  const handleInstacartOrder = async () => {
    ...
    const toastId = toast.loading(
      <div className='max-w-md'>
        <div className='font-bold text-green-700 mb-1 flex gap-x-1'>
          <Image
            src={instacartImg}
            alt='Instacart'
            width={22}
          ...
          />
          <p>Creating Instacart Shopping List...</p>
        </div>
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.success(
          <div className='max-w-md'>
            <div className='font-bold text-green-700 mb-2 flex gap-x-1'>
              <Image
                src={instacartImg}
                alt='Instacart'
                width={22}
      ...
      <div className='container mx-auto px-3 sm:px-4 max-w-[1200px] py-4 sm:py-8 md:py-16 min-h-screen'>
        ...
        <div className='mt-8 bg-linear-to-r from-[#5a9e3a] to-[#4a9fd8] rounded-2xl p-8 text-center text-white'>
          ...
          {!user ? (
            ...
            <button
              onClick={handleInstacartOrder}
              className='font-semibold text-lg flex items-center justify-center mx-auto cursor-pointer rounded-lg hover:opacity-90 transition-opacity'
              style={{
                height: "46px",
